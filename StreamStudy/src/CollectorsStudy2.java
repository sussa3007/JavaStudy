...
public class CollectorsStudy2 {
    public static void main(String[] args) {
        Student3[] stuArr = {
                new Student3("이철수", true,  1, 1, 300),
                new Student3("이자바", false, 1, 1, 250),
                new Student3("문코딩", false, 1, 2, 150),
                new Student3("나자바", true,  1, 2, 100),
                new Student3("김현수", true,  1, 1, 200),
                new Student3("김트림", false, 1, 2,  50),
                new Student3("안현수", false, 1, 3, 100),
                new Student3("홍철수", false, 1, 3, 150),
                new Student3("황코딩", true,  1, 3, 200),
                new Student3("강자바", true,  2, 1, 300),
                new Student3("강노드", false, 2, 1, 250),
                new Student3("최코딩", true,  2, 1, 200),
                new Student3("나노드", false, 2, 2, 150),
                new Student3("문영희", true,  2, 2, 100),
                new Student3("고영희", false, 2, 2,  50),
                new Student3("강아지", false, 2, 3, 100),
                new Student3("이부트", false, 2, 3, 150),
                new Student3("최철기", true,  2, 3, 200)
        };
